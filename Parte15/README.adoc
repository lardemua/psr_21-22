...
Um dos principais parâmetros é a colisão entre um caçador e uma presa, que é o evento que at´ribuí pontos à equipa do caçador, e retira pontos à equipa da presa.

Por não haver tempo suficiente o árbitro é dado já desenvolvido, cabendo aos alunos integrar este software
