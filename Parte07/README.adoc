...
Pretende-se que o programa consiga desenhar rectângulos e círculos na tela. Para o efeito o utilizador terá de premir a tecla correspondente (r ou c para rectângulo ou circulo) e enquanto a tecla está premida e a posição do centroide varia é possivel ver a forma a alterar. Por exemplo, se o utilizador pressionar a tecla "c" para indicar que quer desenahr um circulo na posição do centroide x=100, y=100, então o circulo terá centro nestas coordenadas e o raio será dado pela distância ente o centro e a posição do centroide quando a tecla "c" for libertada. Ver funcionalidade de desenhos do zoom.
