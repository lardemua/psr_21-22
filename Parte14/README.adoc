...
conversão com os comandos:
    ...
    rosrun xacro xacro <player_name>.urdf.xacro -o <player_name>.urdf
    gz sdf -p <player_name>.urdf > <player_name>.sdf

Verifique depois no ficheiro <player_name>.sdf o nome da colisão a colocar.o
Procure pelo campo **sensor** e deverá encontrar algo como:
...
deve ser o que está neste ficheiro.
