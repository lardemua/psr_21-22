...
image::docs/pari_scara.jpg[]

[TIP]
=================
Crie um novo package ROS pari_parte11_scara_description (<robot_name>_description é o nome habitualmente dado aos packages que contêm os ficheiros URDF).
