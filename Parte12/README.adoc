...
Crie um novo ros package chamado **<player_name>_bringup** onde coloca três launch files dentro da pasta launch.
   ...
   - Um terceiro launch file chamado brinpup.launch, os blocos 1 e 3 do turtlebot3_house.launch, e um include do segundo launch file de _spawn_ do robot.
...
O ficheiro _player.gazebo.macro.xacro_ é uma macro, que é uma/home/mike/CATKIN_SRC_CODE_BACKUP/pari_20-21_solutions espécie de função para xacros. Tal como nas funções, as macros têm argumentos de entrada.
