...
Crie um ROS package com o nome __aula9_ex4_bringup_  (bringup é um sufixo normalmente dado aos ros packages que fazem o lançamento de sistemas).
...
types:       _aula8_ex4/Dog [d3e481097da3769123b9dd1b566c9cb3]
topics:      dog1   26 msgs    : _aula8_ex4/Dog (2 connections)
             dog2   13 msgs    : _aula8_ex4/Dog
-----------------------------------------------------------------
