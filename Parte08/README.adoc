...
Crie um http://wiki.ros.org/ROS/Tutorials/CreatingPackage[novo pacote ROS] com o nome _aula8_ex3.
...
O package deve depender do _rospy_ (aliás, todos os packages que conteham programas em python devem depender do ropsy) e também do http://wiki.ros.org/std_msgs[_std_msgs_] e.g.:
    ...
    catkin_create_pkg _aula8_ex3 std_msgs rospy
============================================
...
Crie um novo pacote ROS com o nome __aula8_ex4_, e copie para lá os ficheiros python do exercício anterior.
============================================
