...
Crie um http://wiki.ros.org/ROS/Tutorials/CreatingPackage[novo pacote ROS] com o nome pari_aula8_ex3.
...
Crie um novo pacote ROS com o nome _pari_aula8_ex4_, e copie para lá os ficheiros python do exercício anterior.
============================================
